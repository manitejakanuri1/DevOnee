...
const LICENSE_DATA: Record<string, {
    ...
    'mpl-2.0': {
        level: 'danger',
        description: 'Weak copyleft — modified files must stay under MPL. Contributions restricted by DevOne.',
    ...
    'lgpl-2.1': {
        level: 'danger',
        description: 'Weak copyleft — modifications to the library must be shared. Contributions restricted by DevOne.',
    ...
    'lgpl-3.0': {
        level: 'danger',
        description: 'Weak copyleft — similar to LGPL-2.1 with patent provisions. Contributions restricted by DevOne.',
    ...
    'gpl-2.0': {
        level: 'danger',
        description: 'Strong copyleft — derivative works must be GPL-2.0. Contributions restricted by DevOne.',
    ...
    'gpl-3.0': {
        level: 'danger',
        description: 'Strong copyleft — derivative works must be GPL-3.0. Contributions restricted by DevOne.',
    ...
    'agpl-3.0': {
        level: 'danger',
        description: 'Network copyleft — even SaaS usage requires sharing source code. Contributions restricted by DevOne.',
    ...
    'other': {
        level: 'warning',
        description: 'Non-standard or unrecognized license — proceed with caution.',
...
export function categorizeLicense(
    ...
    if (!licenseKey || licenseKey === 'none') {
        return {
            ...
            description: 'This repository has no license. Under copyright law, all rights are reserved. Proceed with caution.',
            plainLanguage: 'No license detected. The author may have forgotten to add one — contact them before contributing.',
            permissions: [],
